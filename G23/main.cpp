...
Programma izveidota: 2021/03/21; pielabota, testa piemeri: 2021/03/22
...
/************TESTS**************
    ...
    Piezimes:
    > Par ievadi sk. funkcijas 'fill_numeric_list' darbosanas principu
    > FI - funkcijas izpilde (uzdevuma nosacijuma G23)

    Ievads              |          Vēlamā reakcija         |    Rezultāts
    –––––––––-––––––––––+–––––––––––––––––––––––-––––––––––+––––––––––––––––––––––––––-----------------------
     abcdg              | List netika aizpildits, jo       | List netika aizpildits, atkartota ievade
                        | ievaditi nepareizi dati          |
    –––––––––-––––––––––+–––––––––––––––––––––––-––––––––––+–––––––––––––––––––––––––––----------------------
     1                  | List: 1, pec FI: 1, (izmainu nav)| List: 1, pec FI: 1, (izmainu nav)
    –––––––––-––––––––––+–––––––––––––––––––––––-––––––––––+–––––––––––––––––––––––––––----------------------
     1 2.4 3,5 5t6      | List: 1, 2.4, 35, 56             | List: 1, 2.4, 35, 56
                        | pec FI: 1, 2.4, 35, 56           | pec FI: 1, 2.4, 35, 56
                        | (izmainu nav)                    | (izmainu nav)
    –––––––––-––––––––––+–––––––––––––––––––––––-––––––––––+–––––––––––––––––––––––––––----------------------
     2b 56.5 -8 32.6,5  | List: 2, 56.5, -8, 32.65         | List: 2, 56.5, -8, 32.65
                        | pec FI: -8, 32.65                | pec FI: -8, 32.65
...
/*
 Visas funkcijas un saistita saraksta klase ir veidota ar 'template' izmantosanu,
 bet salidzinasana var but izdarita tikai ar 'numeric' tipa datiem (int, float, ...).
 Specifiski bija izvelets 'double', lai paraditu lista aizpildisanu ar peldosa punkta
 saitliem.
*/

/*
 Bija velme paeksperimentet ar 'callback' funkcijam (piem., ka std::sort), kas,
 ka argumentus, panem:
    1) jebkura tipa saistito sarakstu - varetu but gan STL tipa conteineri, kuriem ir
    metodes, kas lauj ierakstit vertibu un parbaudit, vai ta ir tuksa (izmantoju
    std::list pec nosacijuma), gan jebkura lietotaju definets objekts ar tadam pasam
    metodem (push, empty),
    2) saraksta funkciju datu ierakstisanas bridi,
    3) saraksta funkciju, kas parbauda vai saraksts ir tukss.
 Si ir vieniga funkcija, kas izmanto 'callbacks' saja programma.

 Ievades darbosanas princips:
    Input tiek sanemts no 'cin' plusmes (caur getline), kur tiek parbaudits, vai
    skaitlis nesatur neko, iznemot '[0-9]', minusu zimi ('-') (ja ir), un
    punktu ('.') (ja ir). Ja tiek nolasita atstarpe un 'skaitlis' ir un ir pareizs,
    tad tas tiek parversts uz 'double' tipu un ierakstits saraksta.
*/
